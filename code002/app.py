...
import sys
import os
from code002.uipy.mainWindow import Ui_MainWindow
from code002.uipy.dialog1 import Ui_Dialog as Ui_Dialog1
from code002.uipy.dialog2 import Ui_Dialog as Ui_Dialog2
from PyQt5 import QtWidgets
from PyQt5.QtWidgets import QApplication, QMainWindow, QFileDialog, QMessageBox, QDialog
from PyQt5.QtCore import QThread, QObject, pyqtSignal, pyqtSlot
from Line.do_All import getSamples
...
class MyWindow(QMainWindow, Ui_MainWindow):
    ...
    def write(self):
        rstToWrite = "基于神经网络与Line算法的消歧结果如下：\n" + self.result
        if self.target:
